...
export function ActivarLinkCategoria({ nombre, Icon, path }: Categoria) {
    ...
    return (
        <Link href={`/categoria/${path}`} className={cn("flex items-center justify-center flex-row-reverse gap-2 rounded-xl  w-40  py-0.5 text-marusColor-marron/80 transition-colors duration-300 ease-in-out hover:text-marusColor-rojo ", {
