  ...
  return (
    <Sheet open={isCartOpen} onOpenChange={toggleCart}>
      <SheetTrigger asChild>
        <Button className="bg-transparent border-none h-0 hover:bg-transparent">
          {" "}
          <BsCart3 className="text-white size-4" />
        </Button>
      </SheetTrigger>
      <SheetContent
                ...
                <div className="flex items-center gap-2">
                  <div className="flex flex-col justify-center items-center gap-1">
                    <button
                      ...
                      className={`flex items-center justify-center w-6 h-6 rounded-lg p-1 bg-marusColor-anaranjado text-marusColor-marron text-lg cursor-pointer transition-colors duration-300 ease-in-out ${item.quantity >= 15 && "bg-gray-300 text-gray-500"}`}
                    ...
                    <button
                      ...
                      className={`flex items-center justify-center w-6 h-6 rounded-lg p-1 bg-marusColor-anaranjado text-marusColor-marron text-lg cursor-pointer transition-colors duration-300 ease-in-out ${item.quantity <= 1 && "bg-gray-300 text-gray-500"}`}
